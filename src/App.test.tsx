...
//cirando um bloco que agrupa varios testes relacionados
...
describe("App component", ()=>{
    it("should render app component", ()=>{
        ...
        expect(headerTitle).toHaveTextContent("Erick Albert")
    })
    ...
    it("should heading h1 have correct text", ()=>{
        ...
        expect(headingElement).toHaveTextContent("Erick Albert")
